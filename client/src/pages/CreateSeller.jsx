  ...
  return (
    <>
      <div className="w-screen h-screen">
        <Navbar />
        <div className="w-full h-full flex justify-evenly items-center" style={{backgroundColor: '#d4d8f0'}}>
          <div className="w-2/4 h-1/2 drop-shadow rounded-lg flex flex-col justify-evenly items-center" style={{backgroundColor: '#232946'}}>
